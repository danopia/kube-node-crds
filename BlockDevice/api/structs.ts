...
export function toBlockDevice(input: c.JSONValue): BlockDevice & c.ApiKind {
  ...
  return {
    ...c.assertOrAddApiVersionAndKind(obj, "pet.wg69.net/v1", "BlockDevice"),
...
export function fromBlockDevice(input: BlockDevice): c.JSONValue {
  return {
    ...c.assertOrAddApiVersionAndKind(input, "pet.wg69.net/v1", "BlockDevice"),
    ...input,
...
export function toBlockDeviceList(input: c.JSONValue): BlockDeviceList & c.ApiKind {
  const obj = c.checkObj(input);
  return {
    ...c.assertOrAddApiVersionAndKind(obj, "pet.wg69.net/v1", "BlockDeviceList"),
